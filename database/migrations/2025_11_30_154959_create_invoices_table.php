...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('invoices', function (Blueprint $table) {
            ...
            $table->decimal('order_tax_amount', 15, 2)->nullable()->default(0);
            $table->decimal('product_tax_amount', 15, 2)->nullable()->default(0);
            $table->decimal('total_tax_amount', 15, 2)->nullable()->default(0);

            $table->decimal('order_discount', 15, 2)->nullable()->default(0);
            $table->decimal('order_discount_amount', 15, 2)->nullable()->default(0);
            $table->decimal('product_discount_amount', 15, 2)->nullable()->default(0);
            $table->decimal('total_discount_amount', 15, 2)->nullable()->default(0);

            // Payment
            $table->decimal('paid', 15, 2)->nullable()->default(0);
